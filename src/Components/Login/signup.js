...
export default function Signup() {
    ...
    const handleSubmit = async(e) => {
        e.preventDefault();
        const authObject = { 'Project-ID': "2a0da344-c5c3-48a2-9b21-09d300464796", 'User-Name': username, 'User-Secret': password }
                ...
                <div className="container">
                    ...
                    <div className='containerss'>
                        <div>
                            ...
                            <input type="text" placeholder="Enter First Name" name="fname" value={username} onChange={(e)=>setUsername(e.target.value)} required />
                        </div>
                        <div>
                    ...
                    <div className='Symbols'>
                     ...
                     <p><input type='checkbox'></input>I agree to all <a href="#" style={{ color: 'dodgerred' }}>Terms & Privacy</a>.</p>
